...
export function LineupScreen({
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="sticky top-[4.6rem] z-20 -mx-4 overflow-x-auto border-y border-white/10 bg-night/80 px-4 py-3 backdrop-blur-xl sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
